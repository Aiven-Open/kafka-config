...
public class AbstractFragmentSetter<T extends AbstractFragmentSetter<T>> {
   ...
   * @return this.
   */
  protected final T setValue(final String key, final String value) {
   ...
   * @return this.
   */
  protected final T setValue(final String key, final int value) {
   ...
   * @return this.
   */
  protected final T setValue(final String key, final long value) {
   ...
   * @return this.
   */
  protected final T setValue(final String key, final Class<?> value) {
   ...
   * @return this.
   */
  protected final T setValue(final String key, final URI value) {
   ...
   * @return this.
   */
  protected final T setValue(final String key, final boolean state) {
