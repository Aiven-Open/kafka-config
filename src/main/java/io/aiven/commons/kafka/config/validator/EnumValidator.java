 ...
 * }</pre>
 *
 * You can create a case-insensitive validator from the Enum class (recommended for usability: enum
 * constants do not usually differ only by case):
 *
 * <pre>{@code
...
public class EnumValidator {
   ...
   *
   * @param enumClass the class of the Enum that defines the valid values.
   * @return a validator that allows any string value that is a case-insensitive match for the enum
   *     constants in the given Enum class
   */
   ...
   *
   * @param enumClass the class of the Enum that defines the valid values.
   * @return a validator that allows any string value that is a case-sensitive match for the enum
   *     constants in the given Enum class
   */
  public static ConfigDef.Validator caseSensitive(Class<? extends Enum<?>> enumClass) {
    return ConfigDef.ValidString.in(
        Arrays.stream(enumClass.getEnumConstants()).map(Enum::name).toArray(String[]::new));
  }
}
