...
/**
 * Defines the variables that are available for the Velocity template to access a {@link
 * ConfigDef.ConfigKey} object.
 *
...
public class ExtendedConfigKeyBean extends ConfigKeyBean {
  ...
  /**
   * Gets the {@link ExtendedConfigKey} if the extendedFlag is set, otherwise returns null.
   *
