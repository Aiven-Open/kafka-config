...
public class DeprecatedInfo {
  ...
  public static class Builder {
     ...
     * Sets the version in which the option became deprecated.
     *
     * @param sinceBuilder the builder for the version in which the option became deprecated.
     * @return {@code this} instance.
     */
   ...
   *
   * @param description The description.
   * @param since The version label when deprecated.
   * @param forRemoval Whether this option will be removed.
   */
  private DeprecatedInfo(
      final String description, final SinceInfo since, final boolean forRemoval) {
   ...
   *
   * <ul>
   *   <li>{@code name} is the name argument. If {@code name} is empty, the start of the result will
   *       be "Deprecated"
