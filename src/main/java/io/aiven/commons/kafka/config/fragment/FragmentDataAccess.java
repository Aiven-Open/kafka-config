 ...
 * {@link AbstractConfig} and a map of String to {@link ConfigValue}.
 */
public interface FragmentDataAccess {
	 ...
	 * @param key
	 *            The key to check.
	 * @return {@code true} if the key was set, {@code false} if the key was not set
	 *         or does not exist in the config.
	 */
	...
	/**
	 * Creates a configured instance of the class specified by the key. The value of
	 * the key may be either a class name or the instance of the class itsef.
	 *
	 * @param key
	 *            the key to look up.
	 * @param clazz
