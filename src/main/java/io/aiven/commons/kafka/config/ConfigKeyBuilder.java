...
public class ConfigKeyBuilder<T extends ConfigKeyBuilder<?>> {
  ...
  /**
   * The internal config key for this builder. If set to {@code true} the configuration will be an
   * internal config. Defaults to {@code false}
   */
  ...
  /**
   * Generates the documentation. This is an extension point for ConfigKey builders to modify the
   * documentation. For example adding deprecation information, or interactions with other keys in
   * the configuration.
   *
