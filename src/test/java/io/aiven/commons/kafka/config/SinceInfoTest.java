...
public class SinceInfoTest {
  ...
  void OverrideMapTest() throws InvalidVersionSpecificationException {
    ...
    overrideMap.put(
        new SinceInfo.OverrideRange(builder.version("1.0")),
    ...
    overrideMap.put(
        new SinceInfo.OverrideRange(builder.version("[1.0,2.0)")),
    ...
    overrideMap.put(
        new SinceInfo.OverrideRange(builder.version("[1.5,)")),
    ...
    overrideMap.put(
        new SinceInfo.OverrideRange(builder.version("(,1.0],[1.2,)")),
