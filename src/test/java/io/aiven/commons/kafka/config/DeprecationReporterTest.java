...
public class DeprecationReporterTest {
  ...
  private final ConfigDef configDef =
      new ConfigDef()
          .define(
              ExtendedConfigKey.builder("oldgreeting")
                  .defaultValue("Howdy")
                  .deprecatedInfo(
                      DeprecatedInfo.builder()
                          .description("because we say Hi")
                          .since(
                              SinceInfo.builder()
                                  .groupId("g")
                                  .artifactId("a")
                                  ...
                                  .build())
                          .forRemoval(true))
                  .documentation("deprecated with default value")
                  .build())
          .define(
                      ...
                      DeprecatedInfo.builder()
                          ...
                          .since(
                              SinceInfo.builder()
                                  ...
                                  .build())
                          .forRemoval(false))
                  .documentation("deprecated no-default")
                  .build())
          .define(
              ExtendedConfigKey.builder("shangrila")
                  ...
                  .build())
          .define(
              ExtendedConfigKey.builder("greeting")
                  .defaultValue("Howdy")
                  .documentation("not deprecated default")
                  .build());
  ...
  void testChangedDefaultValueReport() {
    ...
    List<String> expected =
        List.of("Option oldgreeting is deprecated for removal since g:a:1960: because we say Hi");
  ...
  void testSetDeprecatedOptionReport() {
    ...
    List<String> expected =
        List.of("Option roads is deprecated since g:a:1985: Where we're going we don't need roads");
    List<String> actual = DeprecationReporter.report(makeConfig(properties), configDef);
    assertThat(actual).containsExactlyInAnyOrderElementsOf(expected);
  }
